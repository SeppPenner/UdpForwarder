...
public static class Program
{
    ...
    /// <summary>
    /// Gets or sets the UDP forwarder service configuration.
    /// </summary>
    private static UdpForwarderConfiguration UdpForwarderConfiguration { get; set; } = new();
    ...
    private static void ReadConfiguration()
    {
        ...
        configuration.Bind(ServiceName, UdpForwarderConfiguration);

        if (!UdpForwarderConfiguration.IsValid())
        {
